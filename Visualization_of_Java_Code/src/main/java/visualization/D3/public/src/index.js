...
import * as cola from "../libs/webcola.js";
//import graph from "./smallgrouped.json" assert {type: 'json'};
var graph;
fetch("smallgrouped.json").then((res) => res.json()).then((data) => graph = data);

import "./style-base.css"assert {type: 'css'};
import "./style-diagram.css"assert {type: 'css'};
